      ...
      <section className="h-screen">
        <div className="container h-full px-6 py-24">
          <div className=" flex h-full flex-wrap justify-center  ">
            ...
            <div className="mb-12 md:mb-0 md:w-8/12 lg:w-6/12 bg-slate-500 p-10 rounded-md flex ">
              <img
            ...
            <div className="md:w-8/12 lg:ml-6 lg:w-5/12  bg-slate-500 p-10 rounded-md">
              <form>
                {/* <!-- Email input --> */}
                <div
                  className="relative mb-6  border-black border-solid border-b-[1px]"
